import { SkeletonPageHeader, SkeletonRegion, SkeletonTable } from '@/components/shared/skeleton'

/**
 * Placeholder while the issue plan resolves.
 *
...
export default function Loading() {
  return (
    <SkeletonRegion label="Working out what would be issued">
      <SkeletonPageHeader />
